...
enum AvailableCoinsType
{
    ...
    ONLY_NONDENOMINATED_NOTMN = 4 // ONLY_NONDENOMINATED and not 1000 SKB at the same time
};
...
public:
    ...
    std::map<std::string, CSkullbuzzNodeConfig> mapMySkullbuzzNodes;
    bool AddSkullbuzzNodeConfig(CSkullbuzzNodeConfig nodeConfig);
