...
{
    resize(900, 500);
    setWindowTitle(tr("SkullBuzz") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("skullbuzz");
    setStyleSheet("#skullbuzz { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #e8e8e8, stop: 1 #e8e8e8);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    labelI2PGenerated->setObjectName("labelI2PGenerated");
    labelI2PGenerated->setStyleSheet("#labelI2PGenerated { color: #ffffff; }");
    ...
    statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #000000, stop: 1 #000000);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SkullBuzz address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/node"), tr("&SkullBuzz Node"), this);
    masternodeManagerAction->setToolTip(tr("Show SkullBuzz Nodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
    tabGroup->addAction(masternodeManagerAction);

    richListPageAction = new QAction(QIcon(":/icons/rlist"), tr("&Rich List"), this);
    richListPageAction->setToolTip(tr("Show top SkullBuzz balances."));
    ...
    aboutAction = new QAction(tr("&About SkullBuzz"), this);
    aboutAction->setToolTip(tr("Show information about SkullBuzz"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SkullBuzz"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; }  } #tabs { color: #ffffff; background-color: qradialgradient(cx: 0.0, cy: 0, fx: 0.0, fy: 0, radius: 0.0, stop: 0 #000000, stop: 1 #000000);  }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SkullBuzz client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SkullBuzz client"));
...
void BitcoinGUI::setNumI2PConnections(int count)
{
    ...
    labelI2PConnections->setToolTip(tr("%n active connection(s) to I2P-SkullBuzz network", "", count));
}
#endif
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SkullBuzz network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SkullBuzz address or malformed URI parameters."));
    }
