...
public:
    ...
    bool WriteSkullbuzzNodeConfig(std::string sAlias, const CSkullbuzzNodeConfig& nodeConfig);
    bool ReadSkullbuzzNodeConfig(std::string sAlias, CSkullbuzzNodeConfig& nodeConfig);
    bool EraseSkullbuzzNodeConfig(std::string sAlias);
