...
bool CWalletDB::WriteSkullbuzzNodeConfig(std::string sAlias, const CSkullbuzzNodeConfig& nodeConfig)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("skullbuzz"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadSkullbuzzNodeConfig(std::string sAlias, CSkullbuzzNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("skullbuzz"), sAlias), nodeConfig);
}

bool CWalletDB::EraseSkullbuzzNodeConfig(std::string sAlias)
{
    nWalletDBUpdated++;
    return Erase(std::make_pair(std::string("skullbuzz"), sAlias));
}
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        else if (strType == "skullbuzz")
	{
	    std::string sAlias;
	    ssKey >> sAlias;
	    CSkullbuzzNodeConfig skullbuzzNodeConfig;
	    ssValue >> skullbuzzNodeConfig;
	    pwallet->mapMySkullbuzzNodes.insert(make_pair(sAlias, skullbuzzNodeConfig));
	}
    } catch (...)
    {
        return false;
